...
class lenandoDE extends CSVPluginGenerator
{
    ...
    private function buildRow($variation, KeyValue $settings, $attributes)
    {
        ...
        if(!is_null($priceList['price']) && $priceList['price'] > 0 && $this->stockHelper->getStock($variation) > 0)
        {
			...
			'Freifeld1'				=> 'Eigenschaft: '.$this->elasticExportItemHelper->getFreeFields($variation['data']['item']['id'], 1),
			'Freifeld2'				=> 'Eigenschaft: '.$this->elasticExportItemHelper->getFreeFields($variation['data']['item']['id'], 2),
			'Freifeld3'				=> 'Eigenschaft: '.$this->elasticExportItemHelper->getFreeFields($variation['data']['item']['id'], 3),
			'Freifeld4'				=> 'Eigenschaft: '.$this->elasticExportItemHelper->getFreeFields($variation['data']['item']['id'], 4),
			'Freifeld5'				=> 'Eigenschaft: '.$this->elasticExportItemHelper->getFreeFields($variation['data']['item']['id'], 5),
			'Freifeld6'				=> 'Eigenschaft: '.$this->elasticExportItemHelper->getFreeFields($variation['data']['item']['id'], 6),
			'Freifeld7'				=> 'Eigenschaft: '.$this->elasticExportItemHelper->getFreeFields($variation['data']['item']['id'], 7),
			'Freifeld8'				=> 'Eigenschaft: '.$this->elasticExportItemHelper->getFreeFields($variation['data']['item']['id'], 8),
			'Freifeld9'				=> 'Eigenschaft: '.$this->elasticExportItemHelper->getFreeFields($variation['data']['item']['id'], 9),
			'Freifeld10'			=> 'Eigenschaft: '.$this->elasticExportItemHelper->getFreeFields($variation['data']['item']['id'], 10),
